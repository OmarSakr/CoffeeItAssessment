...
class SelectedCoffeeTypeAdapter(context: Context) :
    RecyclerView.Adapter<SelectedCoffeeTypeAdapter.ViewHolder>() {

    private var itemList: ArrayList<Type>? = null
